...
export const fullGraphBackdrops: GraphBackdropData[] = [
     ...
     열여덟 항목이 첫 화면에 쏟아지면 정작 "생각이라는 갈래가 있다"가 안 읽힌다. */
  {
    ...
    label: "생각",
    tint: "idea",
    members: ["bd-craft", "fe-philosophy", "dict", "bd-algo", "bd-til"],
  },
  /* 알고리즘 — 작성법·TIL과 같은 모양으로, 접은 채 연다. 지금은 두 항목뿐이라
     펴 둬도 쏟아지지 않지만, 첫 화면에 읽혀야 할 것은 항목이 아니라 갈래
     다섯의 이름이다. 형제가 다 접혀 있는데 여기만 펴면 그 줄이 어긋난다. */
  {
    id: "bd-algo",
    label: "알고리즘",
    tint: "idea",
